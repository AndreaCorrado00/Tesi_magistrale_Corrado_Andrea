...
Fs=2035;
figure(1)
sgtitle(subject_name+", record "+record_id,"FontSize",24)
...
for i=1:5
    ...
    subplot(3,2,i)
    hold on
    plot(t,x_w,'LineWidth',1.2)
  
    hold off
    ylabel('Amplitude [mV]',"FontSize",14)
    xlabel('t [s]',"FontSize",14)
    title(traces(i),"FontSize",16)
    xlim([0, 1])
    hold on
...
figure(2)
sgtitle("Power spectrum estimation: "+subject_name+", record "+record_id,"FontSize",24)
