...
% BUILD_AND_SHOW_EXPECTED_SPECTRUMS Analyzes and plots the spectrum of a
% single beat of ECG signal using various methods.
%
% Inputs:
%   - None
%
...
%
% Description:
%   This function loads ECG simulation data, extracts and processes a single
%   beat of the signal, and plots its spectrum using AR estimation, Welch
%   periodogram, and FFT methods.
