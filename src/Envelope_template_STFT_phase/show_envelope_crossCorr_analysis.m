function show_envelope_crossCorr_analysis(data,env_data,fc,record_id,figure_path)
...
template_gauss = template_gauss / max(template_gauss);
...
[correlation, lags] = xcorr(example_env, template_gauss, 'normalized');
