function TM_dataset = evaluate_TM_2_on_dataset(data, T, fs)
    % EVALUATE_TM_2_ON_DATASET Applies template matching (TM) to a dataset of
    ...
    % subject in the provided dataset. It utilizes a multiphasic template generated 
    ...
    %
    % EXAMPLE:
    %   TM_dataset = evaluate_TM_2_on_dataset(data, T, fs);
    ...
    for i = ["A", "B", "C"]
        ...
        for j = 1:length(subjects)
            ...
            for k = 1:L
                ...
                template = generate_multiphasic_template(fs, T, 5);  % Multiphasic template
