...
for i = ["A", "B", "C"]
    ...
    for j = 1:length(subjects)
        ...
        for h = 1:N
            ...
            %% Envelope
            % disp([sub+"-"+num2str(h)])
            [n_peaks,env_peak1_time,env_peak2_time,env_peak3_time,env_peak1_val,env_peak2_val,env_peak3_val,...
            ...
            [cross_peak,cross_peak_pos,corr_energy]=compute_TM_features(record_id,data, env_data,example_corr,T, fc);
...
envelope_features = cell2table(features_rows, ...
    ...
    'cross_peak','cross_peak_pos','cross_energy',...
    'class'});
