    ...
    for j = 1:length(subjects)
        ...
        for h = 1:N
            ...
            feature_row = {
                ...
                string(Fragmentation),string(App),...
...
envelope_features = cell2table(features_rows, ...
    ...
    'First_peak_env', 'First_peak_env_time', 'Second_peak_env', 'Second__peak_env_time', 'Third_peak_env', 'Third_peak_env_time',...
    'duration', 'silent_phase',...
    'silent_rateo', 'atrial_ventricular_ratio', 'atrial_ventricular_time_ratio', 'minor_to_dominant_ratio', 'minor_to_subdominant_ratio', 'n_active_areas_on_duration_ratio',...
    'cross_peak_TM1', 'cross_peak_time_TM1', 'cross_energy_TM1', ...
    'cross_peak_TM2', 'cross_peak_time_TM2', 'cross_energy_TM2', ...
