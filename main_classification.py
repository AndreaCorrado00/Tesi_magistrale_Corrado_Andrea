...
from heuristic_classifier_C_2 import heuristic_classifier_C_2
from LOPOCV_heuristic_A import LOPOCV_heuristic_A
from LOPOCV_heuristic_B import LOPOCV_heuristic_B
from LOPOCV_heuristic_B_2 import LOPOCV_heuristic_B_2
from LOPOCV_heuristic_C import LOPOCV_heuristic_C
from LOPOCV_heuristic_C_2 import LOPOCV_heuristic_C_2
...
from tune_his_th_on_ampl import tune_his_th_on_ampl
...
# %% Tuning of His Threshold value for strategy B
# F1 score is used to tune the best percentile to be used as threshold
th_his,perc_selected=tune_relative_his_th_on_f1(x_train,y_train,np.arange(0,100,5),t_atr=0.38,t_ven=0.42,plot=True)
save_plot(plt.gcf(),other_fig_path,"his_th_tuning_BC_2")

tune_his_th_on_ampl(x_train,t_atr=0.38,t_ven=0.42,Q_perc=perc_selected,boxplot=True);
save_plot(plt.gcf(),other_fig_path,"his_th_tuning_boxplot_BC_2")
# %%  Heuristic classifier: train
dims=x_train.shape
pred_heuristic=np.empty(dims[0], dtype=object)
...
cm_saving_path=figure_path+"/Heuristic_classification_phase"+fig_final_folder
# Variable saving names
cm_saving_name="CM_heuristic_train_B_2"+plot_last_name
cm_title=subtitle_plots+" train set B 2" 
#confusion matrix
he_report=evaluate_confusion_matrix(pred_heuristic,y_train,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)

plot_dataframe_as_plain_image(he_report, figsize=(4, 4), scale=(1,1.3),title_plot=cm_title, use_rowLabels=True,path=cm_saving_path,saving_name="report_train_B_2")
# %% Heuristic classifier: test 
dims=x_test.shape
pred_heuristic=np.empty(dims[0], dtype=object)
...
# %% Performance of the heuristic classifier: train 
cm_saving_name="CM_heuristic_test_B_2"+plot_last_name
cm_title=subtitle_plots+" test set B 2" 
#confusion matrix
he_report=evaluate_confusion_matrix(pred_heuristic,y_test,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)
...
# with sub 2: 2 38 40
# without sub 2: 0, 188,230
show_single_example(x_test, Fs,2, 'MAP A correctly classified as MAP A, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[2][4],disp_atr_vent_boxes=False)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_1_B_2")

show_single_example(x_test, Fs,38, 'MAP B correctly classified as MAP B, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[38][4],disp_atr_vent_boxes=False)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_2_B_2")

show_single_example(x_test, Fs, 40, 'MAP C correctly classified as MAP C, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[40][4],disp_atr_vent_boxes=False)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_3_B_2")

# %% Showing some unclear results
# with sub 2: 1, 117, 290
# without sub 2: 5, 113, 252
show_single_example(x_test, Fs,1, 'MAP A classified as MAP B, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[1][4],disp_atr_vent_boxes=False)
save_plot(plt.gcf(),other_fig_path,"ex_misclass_1_B_2")

show_single_example(x_test, Fs,117, 'MAP C classified as MAP B, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[117][4],disp_atr_vent_boxes=False)
save_plot(plt.gcf(),other_fig_path,"ex_misclass_2_B_2")

show_single_example(x_test, Fs, 290, 'MAP C classified as MAP A, strategy B 2') 
draw_his_boundaries(0.38,0.42, signal_peaks_and_class_test[290][4],disp_atr_vent_boxes=False)
...
show_single_example(x_test, Fs,222 , 'MAP C classified as MAP A, strategy C') 
draw_his_boundaries(0.38,0.42,th_his,disp_atr_vent_boxes=True)
...
cm_saving_path=figure_path+"/Heuristic_classification_phase"+fig_final_folder
# Variable saving names
cm_saving_name="CM_heuristic_train_C_2"+plot_last_name
cm_title=subtitle_plots+" train set C 2" 
#confusion matrix
he_report=evaluate_confusion_matrix(pred_heuristic,y_train,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)
plot_dataframe_as_plain_image(he_report, figsize=(4, 4), scale=(1,1.3),title_plot=cm_title, use_rowLabels=True,path=cm_saving_path,saving_name="report_train_C_2")
...
# %% Performance of the heuristic classifier: train 
cm_saving_name="CM_heuristic_test_C_2"+plot_last_name
cm_title=subtitle_plots+" test set C 2" 
#confusion matrix
he_report=evaluate_confusion_matrix(pred_heuristic,y_test,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)
...
# with sub 2: 2,38, 3
# without sub 2: 19, 188, 195
show_single_example(x_test, Fs,2, 'MAP A correctly classified as MAP A, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[2][4],disp_atr_vent_boxes=True)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_1_C_2")

show_single_example(x_test, Fs,38, 'MAP B correctly classified as MAP B, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[38][4],disp_atr_vent_boxes=True)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_2_C_2")

show_single_example(x_test, Fs, 3, 'MAP C correctly classified as MAP C, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[3][4],disp_atr_vent_boxes=True)
save_plot(plt.gcf(),other_fig_path,"ex_correct_class_3_C_2")

# %% Showing some unclear results
# with sub 2: 0, 13, 222
# without sub 2: 5, 113, 252
show_single_example(x_test, Fs, 0, 'MAP A classified as MAP B, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[0][4],disp_atr_vent_boxes=True)
save_plot(plt.gcf(),other_fig_path,"ex_misclass_1_C_2")

show_single_example(x_test, Fs,13, 'MAP C classified as MAP B, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[13][4],disp_atr_vent_boxes=True)
save_plot(plt.gcf(),other_fig_path,"ex_misclass_2_C_2")

show_single_example(x_test, Fs,222 , 'MAP C classified as MAP A, strategy C 2') 
draw_his_boundaries(0.38,0.42,signal_peaks_and_class_test[222][4],disp_atr_vent_boxes=True)
...
# %% STRATEGY B_2 LOPOCV
y_true_LOPOCV,y_pred_LOPOCV,signal_peaks_and_class_train_LOPOCV=LOPOCV_heuristic_B_2(whole_dataset)
...
cm_saving_path=figure_path+"/Heuristic_classification_phase"+fig_final_folder
# Variable saving names
cm_saving_name="CM_heuristic_LOPOCV_B_2"+plot_last_name
cm_title=subtitle_plots+" LOPOCV, heuristic B 2" 
he_report=evaluate_confusion_matrix(y_pred_LOPOCV,y_true_LOPOCV,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)
plot_dataframe_as_plain_image(he_report, figsize=(4, 4), scale=(1,1.3),title_plot=cm_title, use_rowLabels=True,path=cm_saving_path,saving_name="report_LOPOCV_B_2")

# misclassified per class
miss_class_summary= misclassification_summary(whole_dataset,y_pred_LOPOCV, labels_unique)
plot_dataframe_as_plain_image(miss_class_summary, figsize=(8,5),scale=(1.7,1.7),title_plot=cm_title,path=other_fig_path,saving_name="Misclass_LOPOCV_B_2")
...
# %% STRATEGY C 2
y_true_LOPOCV,y_pred_LOPOCV,signal_peaks_and_class_train_LOPOCV=LOPOCV_heuristic_C_2(whole_dataset)
...
cm_saving_path=figure_path+"/Heuristic_classification_phase"+fig_final_folder
# Variable saving names
cm_saving_name="CM_heuristic_LOPOCV_C_2"+plot_last_name
cm_title=subtitle_plots+" LOPOCV, heuristic C 2" 
he_report=evaluate_confusion_matrix(y_pred_LOPOCV,y_true_LOPOCV,labels_unique,cm_suptitle=cm_suptitle,cm_title=cm_title,save=True, path=cm_saving_path,saving_name=cm_saving_name)
plot_dataframe_as_plain_image(he_report, figsize=(4, 4), scale=(1,1.3),title_plot=cm_title, use_rowLabels=True,path=cm_saving_path,saving_name="report_LOPOCV_C_2")

# misclassified per class
miss_class_summary= misclassification_summary(whole_dataset,y_pred_LOPOCV, labels_unique)
plot_dataframe_as_plain_image(miss_class_summary, figsize=(8,5),scale=(1.7,1.7),title_plot=cm_title,path=other_fig_path,saving_name="Misclass_LOPOCV_C_2")
